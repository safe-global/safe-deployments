...
const multiSendDeployments: SingletonDeployment[] = [MultiSend141, MultiSend130, MultiSend111];
...
const multiSendCallOnlyDeployments: SingletonDeployment[] = [MultiSendCallOnly141, MultiSendCallOnly130];
...
// This is a sorted array (by preference)
const createCallDeployments: SingletonDeployment[] = [CreateCall141, CreateCall130];
...
const signMessageLibDeployments: SingletonDeployment[] = [SignMessageLib141, SignMessageLib130];
